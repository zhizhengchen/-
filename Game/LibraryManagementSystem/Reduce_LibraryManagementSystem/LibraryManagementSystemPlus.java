...
public class LibraryManagementSystemPlus {
    ...
    public static void menu(){
        ...
        switch (choice) {
            case 1:
                showAll(bookNames, authors, status, dates, returnDates, counts);
                break;
            case 2:
                findBook(bookNames, authors, status, dates, returnDates, counts);
                break;
            case 3:
                borrowBook(bookNames, authors, status, dates, returnDates, counts);
                break;
            case 4:
                returnBook(bookNames, authors, status, dates, returnDates, counts);
                break;
            case 5:
                addBook(bookNames, authors, status, dates, returnDates, counts);
                break;
            case 6:
                delBook(bookNames, authors, status, dates, returnDates, counts);
                break;
            case 0:
                System.exit(0);
                break;
        ...
        menu(bookNames, authors, status, dates, returnDates, counts);
    }
    public static void menu(String[] bookNames,String[] authors,int[] status,int[] dates,int[] returnDates,int[] counts){
        System.out.println("欢迎来到图书管理系统");
        System.out.println("==================");
        System.out.println("1. 查看所有图书");
        System.out.println("2. 根据名字查看图书");
    ...
    public static void showAll(String[] bookNames,String[] authors,int[] status,int[] dates,int[] returnDates,int[] counts){
    ...
    public static void findBook(String[] bookNames,String[] authors,int[] status,int[] dates,int[] returnDates,int[] counts){
    ...
    public static void borrowBook(String[] bookNames,String[] authors,int[] status,int[] dates,int[] returnDates,int[] counts){
        System.out.println("请输入图书名字");
        String bookName  = input.next();
        for (int i = 0; i < bookNames.length; i++) {
            if (bookNames[i].equals(bookName)) {
    ...
    public static void returnBook(String[] bookNames,String[] authors,int[] status,int[] dates,int[] returnDates,int[] counts){
        System.out.println("请输入图书名字");
        String bookName  = input.next();
        for (int i = 0; i < bookNames.length; i++) {
            if (bookNames[i].equals(bookName)) {
    ...
    public static void addBook(String[] bookNames,String[] authors,int[] status,int[] dates,int[] returnDates,int[] counts){
    ...
    public static void delBook(String[] bookNames,String[] authors,int[] status,int[] dates,int[] returnDates,int[] counts){
        boolean flag = false;
        int index = -1;
